...
<style>
    /* ===== COA DESIGN SYSTEM - Amber / Sky / Emerald ===== */
    .coa-root {
    ...
    .coa-search-icon {
        ...
        width: 1rem; height: 1rem; color: #64748b; pointer-events: none;
    }
    .coa-search {
        width: 100%;
        background: #0f172a;
    ...
    .coa-search::placeholder { color: #64748b; }
    ...
    .coa-btn-expand {
        ...
        background: rgb(245 158 11 / 0.12); border: 1px solid rgb(245 158 11 / 0.3); color: #fbbf24;
        transition: all 0.15s;
    }
    .coa-btn-expand:hover { background: rgb(245 158 11 / 0.22); }
    .coa-btn-collapse {
        display: inline-flex; align-items: center; gap: 0.375rem;
        padding: 0.45rem 0.9rem; border-radius: 0.5rem; font-size: 0.8rem; font-weight: 600; cursor: pointer;
    ...
    .coa-btn-collapse:hover { border-color: #334155; color: #e2e8f0; }
    .coa-stat {
        margin-left: auto; font-size: 0.8rem; font-weight: 700; color: #fbbf24;
        background: rgb(245 158 11 / 0.08); border: 1px solid rgb(245 158 11 / 0.2);
    ...
    .coa-legend {
        ...
        padding: 0.625rem 1rem; background: #0f172a; border: 1px solid #1e293b;
        border-radius: 0.625rem; margin-bottom: 1.25rem; font-size: 0.75rem;
    }
    .coa-legend-item { display: flex; align-items: center; gap: 0.375rem; color: #64748b; }
    ...
    .b-de {
        ...
        border-radius: 0.25rem; background: rgb(245 158 11 / 0.15); color: #fbbf24;
        border: 1px solid rgb(245 158 11 / 0.3);
    }
    .b-kr {
        font-size: 0.65rem; font-weight: 800; letter-spacing: 0.06em; padding: 0.12rem 0.4rem;
        border-radius: 0.25rem; background: rgb(244 63 94 / 0.15); color: #fb7185;
    ...
    .row-induk-hd:hover { background: rgb(245 158 11 / 0.05); }
    .kode-induk { font-size: 0.82rem; font-weight: 800; color: #fbbf24; min-width: 3rem; letter-spacing: 0.02em; }
    .nama-induk { flex: 1; font-size: 0.95rem; font-weight: 700; color: #e2e8f0; }

    /* ANAK */
    .anak-list { padding: 0 0.625rem 0.625rem 1.5rem; }
    .anak-list-inner { border-top: 1px solid rgb(30 41 59 / 0.5); padding-top: 0.25rem; }
    .row-anak {
        border-left: 2px solid #38bdf8;
        background: rgb(56 189 248 / 0.04);
        border-radius: 0 0.5rem 0.5rem 0; margin-bottom: 0.375rem; overflow: hidden;
    }
    .row-anak:hover { background: rgb(56 189 248 / 0.07); }
    .row-anak-hd {
        display: flex; align-items: center; padding: 0.55rem 0.875rem;
        cursor: pointer; user-select: none; gap: 0.5rem;
    }
    .kode-anak { font-size: 0.78rem; font-weight: 700; color: #38bdf8; min-width: 2.75rem; }
    .nama-anak { flex: 1; font-size: 0.875rem; font-weight: 600; color: #cbd5e1; }
    ...
    .row-sub:hover { background: rgb(255 255 255 / 0.015); }
    .sub-bullet { width: 5px; height: 5px; border-radius: 50%; background: #4ade80; flex-shrink: 0; }
    .kode-sub { font-size: 0.72rem; font-weight: 600; color: #4ade80; min-width: 4rem; font-variant-numeric: tabular-nums; }
    .nama-sub { flex: 1; font-size: 0.8125rem; color: #94a3b8; }
    ...
    .kode-child { font-size: 0.75rem; font-weight: 700; color: #c084fc; min-width: 2.75rem; }
    .nama-child { flex: 1; font-size: 0.85rem; font-weight: 500; color: #a78bfa; }

    /* Chevron */
    .chev { width: 14px; height: 14px; color: #64748b; transition: transform 0.18s, color 0.18s; flex-shrink: 0; }
    .chev.open-induk { transform: rotate(90deg); color: #fbbf24; }
    .chev.open-anak  { transform: rotate(90deg); color: #38bdf8; }

    /* Count pills */
    .cpill { font-size: 0.7rem; font-weight: 700; padding: 0.15rem 0.5rem; border-radius: 2rem; }
    .cpill-induk { background: rgb(245 158 11 / 0.15); color: #fbbf24; }
    .cpill-anak  { background: rgb(56 189 248 / 0.12); color: #7dd3fc; }

    /* Empty */
    .coa-empty { text-align: center; padding: 4rem 1rem; color: #475569; }
</style>
